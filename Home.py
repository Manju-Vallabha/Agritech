...
with content:
    ...
    with c_22:
        ...
        st.markdown("<br><br>", unsafe_allow_html=True)
    st.markdown("<br><br>", unsafe_allow_html=True)
    text = "The Project is developed by Team  Rudra from Kalasalingam Academy of Research and Education, Krishnankoil, Tamil Nadu, India.<br>The team members are:<br><br>1. Manju Vallabha Pavalla<br>2. Venkata Jesmitha Keerthipati<br>3. Sai Jaideep Keerthipati<br>4. Reeshma Muppala"
    html_code = f"""
            <div style='
                background-color: #2A2937;
                border-radius: 5px;
